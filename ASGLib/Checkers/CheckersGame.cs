...
{
    internal class CheckersGame : ASG<CheckersGame, CheckersMove, CheckersMoveDTO>
    {
        // --- CONSTRTUCTORS & FACTORIES ---
        private CheckersGame() : base("") { } //NOT YOURS; DONT TOUCH

        internal CheckersGame(string path) : base(path)
        {
            ParsePDNFile(path);
        }
